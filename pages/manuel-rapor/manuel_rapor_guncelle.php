...
<section class="content">
    <div class="container">
        ...
        <div class="row">
                        ...
                        <div class="body">
                            <div class="row pw_content">
                                <div class="col-12 pw_header">
                                    <h6>Manuel Bildirilen Rapor Bildirimi</h6>
                                    <small class="text-muted">
                                        Manuel rapor bildirimi yapabilirsiniz.
                                    </small>
            ...
            <div class="col-lg-6 col-md-12">
                <a href="manuel-rapor-guncelleme">
                    <div class="card project_widget">
                        <div class="body">
                            <div class="row pw_content">
                                <div class="col-12 pw_header">
                                    <h6> Manuel Bildirilen Rapor Güncelleme</h6>
                                    <small class="text-muted">
                                        Manuel bildirilen raporları güncelleyebilirsiniz.

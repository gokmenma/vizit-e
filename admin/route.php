...
$router->get('sign-in', 'login.php')
    ...
    ->post('paket-kaydet', 'pages/paketler/APIPaketler.php')
    ->post('paket-sil', 'pages/paketler/APIPaketler.php')
    ...
    ->post('satinalma-onayla', 'pages/satinalmalar/APISatinalmalar.php')

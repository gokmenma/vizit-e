...
<div class="animate-in" style="max-width: 800px; margin: 0 auto;">
    <div style="margin-bottom: 2rem;">
        ...
        <p style="color: #71717a; font-size: 0.875rem; margin-top: 0.25rem;">Kişisel bilgilerinizi ve hesap ayarlarınızı buradan yönetebilirsiniz.</p>
    </div>

    <div style="display: grid; gap: 2rem;">
        <!-- Profil Kartı -->
        <div class="card" style="padding: 2rem; border-radius: 12px; border: 1px solid #e4e4e7;">
            <div style="display: flex; align-items: center; gap: 1.5rem; margin-bottom: 2rem; padding-bottom: 2rem; border-bottom: 1px solid #f4f4f5;">
                <div style="width: 80px; height: 80px; border-radius: 50%; background: #18181b; color: white; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; font-weight: 700; border: 4px solid #f4f4f5; box-shadow: 0 0 0 1px #e4e4e7;">
                    <?php echo $initials; ?>
                </div>
                <div>
                    <h2 style="font-size: 1.25rem; font-weight: 700; margin: 0;"><?php echo htmlspecialchars($user->adi_soyadi ?: $user->kullanici_adi); ?></h2>
                    <p style="color: #71717a; font-size: 0.875rem; margin: 0.25rem 0 0.5rem;"><?php echo htmlspecialchars($user->email); ?></p>
            ...
            <form id="profile-form" onsubmit="event.preventDefault(); submitProfileUpdate(this);" style="display: grid; gap: 1.5rem;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    <div class="form-group">
                        <label class="form-label" style="font-weight: 600; color: #18181b;">Ad Soyad</label>
                    ...
                    <div class="form-group">
                        <label class="form-label" style="font-weight: 600; color: #18181b;">Kullanıcı Adı</label>
                        <div class="input-icon-wrapper">
                ...
                <div class="form-group">
                    <label class="form-label" style="font-weight: 600; color: #18181b;">E-posta Adresi</label>
                    <div class="input-icon-wrapper">
                    ...
                    <p style="color: #71717a; font-size: 0.75rem; margin-top: 0.5rem;">Giriş yapmak ve bildirim almak için kullanılır.</p>
                </div>

                <div style="padding: 1.5rem; background: #fafafa; border-radius: 8px; border: 1px dashed #e4e4e7; margin-top: 0.5rem;">
                    ...
                    <p style="color: #71717a; font-size: 0.75rem; margin-top: 0.75rem;">Şifrenizi değiştirmek istemiyorsanız bu alanları boş bırakın.</p>
                </div>

                <div style="display: flex; justify-content: flex-end; gap: 1rem; margin-top: 1rem;">
                    <button type="submit" class="btn" style="background: #18181b; color: white; padding: 0.625rem 2rem;">
        ...
        <!-- Hesap Bilgileri -->
        <div class="card" style="padding: 1.5rem; border-radius: 12px; border: 1px solid #e4e4e7; background: #fcfcfc;">
             <h3 style="font-size: 0.875rem; font-weight: 700; margin: 0 0 1.25rem; color: #71717a; text-transform: uppercase; letter-spacing: 0.05em;">Hesap Detayları</h3>
             <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
                <div>
                    <span style="display: block; font-size: 0.75rem; color: #71717a; margin-bottom: 0.25rem;">Kayıt Tarihi</span>
                    <span style="font-weight: 600; color: #18181b;"><?php echo date('d F Y', strtotime($user->kayit_tarihi)); ?></span>
                </div>
                <div>
                    <span style="display: block; font-size: 0.75rem; color: #71717a; margin-bottom: 0.25rem;">Hesap Durumu</span>
                ...
                <div>
                    <span style="display: block; font-size: 0.75rem; color: #71717a; margin-bottom: 0.25rem;">Son Giriş</span>
                    <span style="font-weight: 600; color: #18181b;">Bugün</span>
                </div>
             </div>
        </div>
    </div>
